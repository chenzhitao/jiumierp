...
public class LoginService
{
    ...
    public User login(String username, String password)
    {
        ...
        if (!StringUtils.isEmpty(securityCode)&&"N".equals(securityCode)){
            throw new SysExpireException();
        }else if(!StringUtils.isEmpty(securityCode)&&"E".equals(securityCode)){
            throw new SysValidErrorException();
        }
