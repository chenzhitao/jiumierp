package com.ruoyi.project.config.configProductionTemplate.domain;
...
/**
 * 生产工艺卡对象 config_production_template
 * 
 * @author fangzhou
 * @date 2021-04-13
 */
public class ConfigProductionTemplate extends BaseEntity
{
