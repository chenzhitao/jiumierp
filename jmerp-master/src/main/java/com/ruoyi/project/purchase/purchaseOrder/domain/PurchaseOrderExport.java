package com.ruoyi.project.purchase.purchaseOrder.domain;
 ...
 * @date 2021-05-08
 */
public class PurchaseOrderExport extends BaseEntity
{
    ...
    /** 订金日期 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "订金日期", width = 30, dateFormat = "yyyy-MM-dd")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("depositDate", getDepositDate())
            .toString();
    }
